...
<?php
	...
	function socialbuttons_main(){
		if(isset($_REQUEST['uni_setting_do']) && $_REQUEST['uni_setting_do'] == 1){
			$social_buttons_enable_option = ($_REQUEST['social_buttons_enable']!="")?$_REQUEST['social_buttons_enable']:2;
			$social_buttons_fixedPosition = ($_REQUEST['social_buttons_fixedPosition']!="")?$_REQUEST['social_buttons_fixedPosition']:2;
	...
	?>
	<div class="updated" id="message">
		<p> <strong> SocialButton Deactivated </strong> </p> 
	</div>
	<?php
		}
					...
					<div class="inside">
						<div id="titlediv">
							<div id="titlewrap">
								...
								<label style="cursor: pointer; margin-left: 10px;" for="social_buttons_enable">Show Floating Social Buttons?</label><font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Default yes.</font>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="inside">
						<div id="titlediv">
							<div id="titlewrap">
								...
								<label style="cursor: pointer; margin-left: 10px;" for="social_buttons_fixedPosition">Make Floating Social Buttons Position Fixed?</label><font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Default no.</font>
							</div>
						</div>
					</div>
				</div>
				<div class="postbox" id="social_buttons_orentation" style="margin-top: 20px; margin-left: 30px; width: 90%;">
					<h3 style="padding: 7px 10px;" class="hndle"><span>Floating Social Buttons Orentation</span></h3>
					<div class="inside">
						<div id="titlediv">
							<div id="titlewrap">
								...
								</select><font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Default Right.</font>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="inside">
						...
						<div>
							...
							<div style="display: inline; padding-left: 10px;"> 
								<?php echo $social_buttons_top; ?> px <font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Default 10px.</font>
							</div>
						</div>
						...
						<div class="hide-if-js" id="txfx-links-to-alternate-section" style="margin-left: 30px; display: none;">
							<p>
								...
								<font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Example: 10px - default is 10px.</font>
							</p>
						</div>
						<script>
							(function($){
	...
	<h2><?php _e("Floating Social Buttons"); ?></h2>

	<?php 

		$achecked = '';
		$ichecked = '';
		if($socialbuttons_data->active != ""){
		...
		$new_window_checked = '';
		if($socialbuttons_data->open_in_new_window != ""){
									...
									<div class="inside">
										<div id="titlediv">
											<div id="titlewrap">
												...
												<input type="text" autocomplete="off" id="title" value="<?php echo $socialbuttons_data->social_net_name ?>" tabindex="1" size="30" name="snn_title">
											</div>
										</div>
									</div>
								</div>
								<div class="postbox" id="page-links-to" style="position: inherit;">
									...
									<div class="inside" style="position: inherit;">
										...
										<div>
											...
											<div style="display: inline; padding-left: 10px;"><img style="position: absolute; margin-top: -8px;" src="<?php echo $socialbuttons_data->social_img_link ?>"></div>
										</div>
										<p style="margin-top: 32px;">
											<label>
								...
								<div class="postbox" id="revisionsdiv">
									...
									<div class="inside">
										...
										<p style="margin-top: 32px;">
											...
											<label for="inactive_status" style="margin-left: 20px;" >Deactivate
												<font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Click to deactivate.</font>
											</label>
										</p>
								...
								<div class="postbox" id="revisionsdiv">
									...
									<div class="inside">
										...
										<label style="margin-left: 10px;" for="in_new_window">Open link in new window?
											<font style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;* Default yes.</font>
										</label>
									</div>
								</div>
								<div class="postbox" id="social_net_name">
									...
									<div class="inside">
										<div id="titlediv">
											<div id="titlewrap">
												...
												<input type="text" autocomplete="off" id="title" value="<?php echo $socialbuttons_data->social_url ?>" tabindex="1" size="30" name="snn_surl">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="inside">
										<div id="titlediv">
											<div id="titlewrap">
												...
												<input type="text" autocomplete="off" id="title" value="<?php echo $socialbuttons_data->social_tooltip_html ?>" tabindex="1" size="30" name="snn_tooltip">
											</div>
										</div>
									</div>
								</div>
